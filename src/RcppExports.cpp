...
RcppExport SEXP _iplsv_nlipC(SEXP PHISEXP, SEXP THETASEXP, SEXP PSISEXP, SEXP docsSEXP, SEXP etaSEXP, SEXP gammaSEXP, SEXP betaSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    Rcpp::traits::input_parameter< double >::type gamma(gammaSEXP);
    Rcpp::traits::input_parameter< double >::type beta(betaSEXP);
    rcpp_result_gen = Rcpp::wrap(nlipC(PHI, THETA, PSI, docs, eta, gamma, beta));
    return rcpp_result_gen;
END_RCPP
}
// g_nlipC
List g_nlipC(arma::mat PHI, arma::mat THETA, arma::mat PSI, arma::uvec Ns, List docs, double eta, double gamma, double beta);
RcppExport SEXP _iplsv_g_nlipC(SEXP PHISEXP, SEXP THETASEXP, SEXP PSISEXP, SEXP NsSEXP, SEXP docsSEXP, SEXP etaSEXP, SEXP gammaSEXP, SEXP betaSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< arma::mat >::type PHI(PHISEXP);
    ...
    Rcpp::traits::input_parameter< double >::type gamma(gammaSEXP);
    Rcpp::traits::input_parameter< double >::type beta(betaSEXP);
    rcpp_result_gen = Rcpp::wrap(g_nlipC(PHI, THETA, PSI, Ns, docs, eta, gamma, beta));
    return rcpp_result_gen;
END_RCPP
}
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_iplsv_nlipC", (DL_FUNC) &_iplsv_nlipC, 7},
    {"_iplsv_g_nlipC", (DL_FUNC) &_iplsv_g_nlipC, 8},
    {NULL, NULL, 0}
};
